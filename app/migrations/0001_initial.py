# Generated by Django 5.0.12 on 2025-03-02 20:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('single_trade', models.PositiveSmallIntegerField(default=50, verbose_name='Percentage of available margin to risk on a single trade')),
                ...
                ('trail_multiplier', models.FloatField(default=0.3, verbose_name='ATR multiplier for trailing stop/loss')),
                ('limit_multiplier', models.PositiveSmallIntegerField(default=3, verbose_name='PIP multiplier for limit')),
                ('on_status', models.BooleanField(default=True, verbose_name='On/Off')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tpprice', models.FloatField(blank=True, null=True, verbose_name='Target take-profit price')),
                ...
                ('status', models.CharField(blank=True, choices=[('PENDING', 'Pending'), ('FILLED', 'Filled'), ('TRIGGERED', 'Triggered'), ('CANCELLED', 'Cancelled'), ('OPEN', 'Open'), ('CLOSED', 'Closed'), ('TRAILING', 'Trailing')], max_length=9)),
                ('close_status', models.CharField(blank=True, choices=[('P', 'Profit'), ('L', 'Loss')], max_length=1)),
                ...
                ('sl_id', models.CharField(blank=True, max_length=24, verbose_name='Stop-loss ID')),
                ('bot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.bot')),
            ],
            options={
                'ordering': ['-pk'],
